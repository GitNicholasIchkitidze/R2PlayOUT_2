...
using CasparCg.AmcpClient.Common.Exceptions;
...
namespace CasparCg.AmcpClient.Common
{
    ...
    {
        public static AmcpParsedData dataResponsed;
        //public static AmcpParsedData DataRequested;
        public static string DataRequested;

        internal override void ProcessData(AmcpParsedData data)
        {
            //DataRequested = data.ToString();
            dataResponsed = data;
            CheckResponse(data);
        }
